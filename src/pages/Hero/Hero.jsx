...
export default function Hero() {
  const words = [
    ...
    "REST API & Microservices Expert",
    "Big Data & Cloud Enthusiast",
  ];

  const [code] = useState(`
const profile = {
    name: 'Ali Alperen Karaca',
    title: 'Senior Software Engineer | Problem Solver',
    skills: [
        'React', 'Java', 'Spring Boot', 'Node.js',
        'REST APIs', 'Microservices', 'Hadoop', 'AWS',
        'GraphQL', 'Git', 'PostgreSQL', 'MongoDB'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Java & React lover 🚀 | Microservices architect 🔧 | Building scalable enterprise applications 💻✨
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/alperenkaraca"
              ...
              {/* Floating badges */}
                ...
                <div className="px-4 py-2 rounded-lg bg-purple-500/10 backdrop-blur-sm border border-purple-500/20 text-purple-400">
                  <i className="fas fa-server"></i>&nbsp;&nbsp;API Lover
                </div>
              </div>
